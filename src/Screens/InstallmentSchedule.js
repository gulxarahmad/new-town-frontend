...
export default function InstallmentSchedule() {
    ...
    return (
        ...
        <input type="number" placeholder="Add Installment" onChange={(e)=>{setInstallment(e.target.value)}} />
        </div>
        <div ref={componentRef} style={{marginLeft:30, marginRight:30, marginTop:30}}>
        ...
        <h1 style={{marginLeft:200, fontWeight:'bold'}}>Installment Schedule Plan</h1>
         <h3>This is Your 30 months Easy Installments Plan for <strong>Plot No. {booking.plotNo}</strong> at <strong>Form No. {booking._id}</strong></h3>
         <h3>The Amount You Have to Pay on Registry Time is: <strong> {numbFormtter.format(balance-installment*30)} Rs.</strong> </h3>
