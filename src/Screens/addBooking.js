...
function AddBooking() {
  ...
  function makeid(length) {
    var result = "";
    var characters = "01234567890123456789123123123234456456";
  ...
  const sendToDB = async (event) => {
    ...
    if (
      ...
      formData.append(
        "registrationNumber",
        "NA" + parseInt(bookingData.clientCNIC) + parseInt(rand)
      );
      ...
      formData.append(
        "balanceAmount",
        bookingData.totalPlotCost - bookingData.downPayment
      );
